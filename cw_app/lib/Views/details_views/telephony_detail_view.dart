...
class TelephonyDetailView extends StatelessWidget {
  final AnimationController animationController;
  final Animation animation;
  final TelephonyDetail detail;
  final BatchPendingsCw batch;

  const TelephonyDetailView(
      {Key key,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        'Cta. origen: ${detail.accountNumber}',
                        textAlign: TextAlign.left,
                        style: TextStyle(
                          fontFamily: FintnessAppTheme.fontName,
                          fontWeight: FontWeight.normal,
                      ...
                      Text(
                        'Concepto de Pago: ${(detail.concept)}',
                        textAlign: TextAlign.left,
                        style: TextStyle(
                          fontFamily: FintnessAppTheme.fontName,
                          fontWeight: FontWeight.normal,
