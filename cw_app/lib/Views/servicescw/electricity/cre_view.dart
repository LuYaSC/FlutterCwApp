...
class CreView extends StatefulWidget {
  @override
  _CreViewState createState() => _CreViewState(this.isRejected, this.batch,
  ...
  CreView(this.isRejected, this.batch, this.operationDescription,
      this.animationController);
}

class _CreViewState extends State<CreView> {
  ...
  _CreViewState(this.isRejected, this.batch, this.operationDescription,
      this.animationController);
              ...
              Container(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    utils.getInput(_fundSource, 'Código fijo'),
                    SizedBox(
                      height: 20.0,
                    ),
                    TitleView(
...
class FavoriteEpsas {
  ...
  static List<FavoriteEpsas> getFav() {
    return <FavoriteEpsas>[
      FavoriteEpsas('1', 'Fav 1 Cre'),
      FavoriteEpsas('2', 'Fav 2 Cre'),
    ];
  }
}
