...
class ElfecView extends StatefulWidget {
  @override
  _ElfecViewState createState() => _ElfecViewState(this.isRejected, this.batch,
  ...
  ElfecView(this.isRejected, this.batch, this.operationDescription,
      this.animationController);
}

class _ElfecViewState extends State<ElfecView> {
  ...
  _ElfecViewState(this.isRejected, this.batch, this.operationDescription,
      this.animationController);
              ...
              Container(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    utils.getInput(_fundSource, 'NUS'),
                    utils.getInput(_fundSource, 'N° de Factura'),
                    SizedBox(
                      height: 20.0,
                    ),
                    TitleView(
...
class FavoriteEpsas {
  ...
  static List<FavoriteEpsas> getFav() {
    return <FavoriteEpsas>[
      FavoriteEpsas('1', 'Fav 1 Elfec'),
      FavoriteEpsas('2', 'Fav 2 Elfec'),
    ];
  }
}
