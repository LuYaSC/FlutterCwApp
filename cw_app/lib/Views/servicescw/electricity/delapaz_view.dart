...
class DelapazView extends StatefulWidget {
  @override
  _DelapazViewState createState() => _DelapazViewState(this.isRejected, this.batch,
  ...
  DelapazView(this.isRejected, this.batch, this.operationDescription,
      this.animationController);
}

class _DelapazViewState extends State<DelapazView> {
  ...
  _DelapazViewState(this.isRejected, this.batch, this.operationDescription,
      this.animationController);
              ...
              Container(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    utils.getInput(_fundSource, 'N° Cliente'),
                    SizedBox(
                      height: 20.0,
                    ),
                    TitleView(
...
class FavoriteEpsas {
  ...
  static List<FavoriteEpsas> getFav() {
    return <FavoriteEpsas>[
      FavoriteEpsas('1', 'Fav 1 Delapaz'),
      FavoriteEpsas('2', 'Fav 2 Delapaz'),
    ];
  }
}
