...
class OwnTransfersView extends StatefulWidget {
  @override
  _OwnTransfersViewState createState() => _OwnTransfersViewState(
      this.isRejected,
      this.batch,
  ...
  OwnTransfersView(this.isRejected, this.batch, this.operationDescription,
      this.animationController);
}

class _OwnTransfersViewState extends State<OwnTransfersView> {
  ...
  _OwnTransfersViewState(this.isRejected, this.batch, this.operationDescription,
      this.animationController);
