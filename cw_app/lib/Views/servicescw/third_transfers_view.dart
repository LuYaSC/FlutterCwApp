...
class ThirdTransfersView extends StatefulWidget {
  @override
  _ThirdTransfersViewState createState() => _ThirdTransfersViewState(
      this.isRejected,
      this.batch,
  ...
  ThirdTransfersView(this.isRejected, this.batch, this.operationDescription,
      this.animationController);
}

class _ThirdTransfersViewState extends State<ThirdTransfersView> {
  ...
  _ThirdTransfersViewState(this.isRejected, this.batch,
              ...
              Container(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    utils.getInput(_fundSource, 'Ingres Cuenta Destino'),
                    SizedBox(
                      height: 20.0,
                    ),
                    utils.getTextTransaction('Cuenta', _selectedCompany.name),
