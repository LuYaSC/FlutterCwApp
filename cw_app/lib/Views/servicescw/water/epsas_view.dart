...
class EpsasView extends StatefulWidget {
  @override
  _EpsasViewState createState() => _EpsasViewState(this.isRejected, this.batch,
  ...
  EpsasView(this.isRejected, this.batch, this.operationDescription,
      this.animationController);
}

class _EpsasViewState extends State<EpsasView> {
  ...
  _EpsasViewState(this.isRejected, this.batch, this.operationDescription,
      this.animationController);
...
class FavoriteEpsas {
  ...
  static List<FavoriteEpsas> getFav() {
    return <FavoriteEpsas>[
      FavoriteEpsas('1', 'Fav 1 epsas'),
      FavoriteEpsas('2', 'Fav 2 epsas'),
    ];
  }
}
