              ...
              Container(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    utils.getDropdown(_selectedBank, _dropdownItemsBank, onChangeDropdownItemBank, Icons.account_balance),
                    utils.getDropdown(_selectedBranchOffice, _dropdownItemsBranchOffice, onChangeDropdownItemBranchOffice, Icons.contacts),
                    SizedBox(
                      height: 20.0,
                    ),
                    TitleView(
